#!/usr/bin/env python
# -*- coding: utf-8 -*-
# Author:   Stanford cs231n, Oleg Razgulyaev
# License:  BSD 3 clause
"""
    Features from Stanford, cs231n
"""
...
def transform_images_HueHog(X_images, num_color_bins=31, verbose=False):
    """ Transform images using hue and HOG.

    Parameters
    ----------
    X_images: array
        N x H X W X C array of pixel data for N images.
    num_color_bins: int, optional (default=31)
    ...
    X_feats = extract_features(X_images, feature_fns, verbose=verbose)
    return X_feats
...
def extract_features(imgs, feature_fns, verbose=False):
    ...
    for i in xrange(1, num_images):
        ...
        if verbose and i % 1000 == 0:
            print('Done extracting features for {:d} / {:d} images'.format(
                i, num_images))
